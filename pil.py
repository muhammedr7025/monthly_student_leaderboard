...
font_karma = ImageFont.truetype("Inter-Black.ttf", 46)  #size of karma
...
font_college = ImageFont.truetype("PlusJakartaSans-Bold.ttf", 25) #size of college
x, y = 95,290
c = 1
j=0
for discord_id, data in total_score.items():
    ...
    name = "Mar baselious college of technology and engineering"
    name = name.upper()
    if len(name) > 17:
        first_line = name[:25]
        ...
        draw.multiline_text((x + 53, y + 100), first_line + "\n" + second_line, fill="rgb(7, 46, 101)", font=font_college,
                            align="left")
    else:
        draw.multiline_text((x + 53, y + 100), name, fill="rgb(7, 46, 101)", font=font_college, align="center")
